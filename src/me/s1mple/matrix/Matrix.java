...
public class Matrix extends JavaPlugin {
	...
	/**
	 * @param skillsapi the skillsapi to set
	 */
	public void setSkillsapi(SkillsPro skillsapi) {
	...
	/**
	 * @param revamp the revamp to set
	 */
	public void setRevamp(VampireRevamp revamp) {
		this.revamp = revamp;
	}
	 ...
	 */
	public void setApi(LuckPerms api) {
		this.api = api;
	}
